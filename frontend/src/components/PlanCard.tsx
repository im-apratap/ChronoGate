...
export default function PlanCard({
  ...
  return (
    <div className="relative p-[1px] rounded-3xl overflow-hidden bg-gradient-to-b from-zinc-800/80 to-zinc-900 hover:from-purple-500/50 hover:to-zinc-900 transition-all">
      <div className="bg-[#09090b] rounded-3xl p-6 h-full flex flex-col justify-between">
        <div>
          ...
          className={`mt-8 w-full py-4 rounded-xl text-sm font-bold transition-all shadow-lg flex justify-center items-center gap-2
            ${
              isPurchased
                ...
                : "bg-purple-600 hover:bg-purple-500 text-white hover:shadow-[0_0_20px_rgba(147,51,234,0.4)]"
            }
